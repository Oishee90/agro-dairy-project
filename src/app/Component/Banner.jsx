...
const Banner = () => {
  ...
  return (
    <div
      className="relative bg-cover bg-center h-[600px] md:h-[600px] "
      style={{
    ...
    >
      ...
      <div className="h-[600px] px-2  md:h-[600px] flex flex-col-reverse md:flex-row justify-between items-center lg:items-start">
        ...
        <div className="content w-full text-center md:text-left md:w-1/2 px-6 mt-36 mb-5 banner-content opacity-0">
          ...
          {/* Button */}
          <div className="mt-4 mb-5 lgd:mt-6 cursor-pointer">
            <button className="relative px-4 py-3 border-2 md:text-bold md:text-xl border-r-4 border-b-4 border-orange-600 border-b-white border-r-white rounded-lg bg-none text-white overflow-hidden group transform transition-all duration-500 ease-out hover:translate-x-4 hover:translate-y-2">
              <span className="relative z-10 flex items-center gap-2">
                <div className="">
                  <LiaShippingFastSolid className="text-inherit text-extrabold w-[24px] h-[18px]" />
                </div>
                Order Now
              </span>
              {/* Color fill from bottom-left corner */}
              <span className="absolute inset-0 bg-orange-600 transform scale-x-0 scale-y-0 origin-bottom-left group-hover:scale-x-100 group-hover:scale-y-100 transition-transform duration-500 ease-out"></span>
            </button>
          </div>
        </div>
